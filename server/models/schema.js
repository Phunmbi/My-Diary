...
const entriesTable = 'CREATE TABLE IF NOT EXISTS entries' + ' (entryid SERIAL PRIMARY KEY NOT NULL,' + 'email CHARACTER VARYING(40) UNIQUE NOT NULL,' + 'title CHARACTER VARYING(20) NOT NULL,' + 'details CHARACTER VARYING(10000) NOT NULL,' + 'last_time_edited TIMESTAMP NOT NULL DEFAULT (NOW())' + ')';
